...
@pytest.mark.parametrize(
    "search_term, transcript, expected_output",
    [
...
def test_find_sentence(search_term: str, transcript: Transcript, expected_output: List[Tuple[int, int, int]]):
    # Arrange
    matcher = SearchTermMatcher()

    # Act
    output = matcher.find_sentence(search_term, transcript)
